...
* Visualization bye scatter plots of the weather of 570 cities across the world radomly selected by coordinates (latutude and longitude) using **citipy**, to showcase the following relationships:
